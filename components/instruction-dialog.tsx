...
export const InstructionDialog = forwardRef<HTMLDivElement, Props>(
      ...
      >
        ...
        <div className="overflow-y-scroll w-full space-y-4 text-white px-5 sm:px-6 py-5">
          <p>
            ...
            only supports entering classic Sudoku puzzles. In classic Sudoku,
            each number between 1 and 9 inclusive can only appear once in each
            row, each column, and each 3 by 3 region (of which there are nine).
          </p>
          <h3 className="text-lg font-bold">General controls</h3>
          <p>
            To select a cell, use the mouse, or the Tab key in combination with
            the arrow keys (Up, Down, Left, and Right). You can use the arrow
            keys (Up, Down, Left, and Right) to move between cells.
          </p>
          ...
          <p>
            You can use the arrow keys (Up, Down, Left, and Right) to move
            between cells. To erase a digit, select its cell and then press the
            same number key.
          </p>
          <p>
          ...
          <p>
            To enter pencil digits, use the mouse or the Tab key to select a
            cell. Now press the appropriate number key (1 to 9) to input that
            digit into the cell as a pencil digit. You can enter multiple pencil
            digits in each empty cell. When you think that you know what the
            digit in a cell should be, select it and then press the appropriate
            number key (1 to 9) and the Ctrl key at the same time.
          </p>
          <p>
            You can use the arrow keys (Up, Down, Left, and Right) to move
            between cells. To erase a pencil digit from a cell, select that cell
            and then press the same number key as that digit. To erase a large
            digit, do the same but press the Ctrl key at the same time.
          </p>
          <p>
